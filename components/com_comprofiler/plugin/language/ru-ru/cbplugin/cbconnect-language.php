<?php
/**
* Community Builder (TM) cbconnect Russian (Russia) language file Frontend
* @version $Id:$
...
'UNLINK_PROVIDER_ACCOUNT'	=>	'Отсоединить свой аккаунт от [sitename]',
'PROVIDER_PROFILE'	=>	'Профиль на провайдере [provider]',
'PROVIDER_PROFILE_ID'	=>	'Провайдер [provider], ID номер провайдера [provider_id]',
'PROVIDER_PROFILE_LINKED_TO_ACCOUNT'	=>	'Ваш профиль  [provider_profile] будет привязан с этим аккаунтом.',
'VIEW_PROVIDER_PROFILE'	=>	'Просмотреть профиль у провайдера [provider]',
...
'APP_ID_81ee9e'	=>	'ID номер приложения',
'INPUT_APPLICATION_SECRET_ac0f26'	=>	'Input application secret.',
'APP_SECRET_61be04'	=>	'Секрет приложения',
...
'CALLBACK_URL_971aa9'	=>	'Обратная URL ссылка ',
