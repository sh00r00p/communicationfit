<?php
/**
* Community Builder (TM) cbgroupjiveevents Russian (Russia) language file Frontend
* @version $Id:$
...
// 48 language strings from file cbgroupjiveevents/component.cbgroupjiveevents.php
