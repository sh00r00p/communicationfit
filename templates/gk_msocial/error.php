...
<link rel="stylesheet" href="<?php echo JURI::base(); ?>templates/<?php echo $this->template; ?>/css/additional.css" type="text/css" />
</head>
...
<footer>
          <p class="desc"><?php echo JText::_('TPL_GK_LANG_ERROR_DESC'); ?></p>
